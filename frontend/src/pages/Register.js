...
const GOOGLE_CLIENT_ID = '843038928917-156ufq5uhk19ebvs3umao28gv15r0q0e.apps.googleusercontent.com';
...
const Register = () => {
  ...
  const handleGoogleRegister = async (response) => {
    try {
      setLoading(true);
      const result = await axios.post(`${API}/auth/google/verify`, {
      ...
      setError(err.response?.data?.detail || 'Google-Registrierung fehlgeschlagen');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div style={{
        ...
        <div style={{ marginTop: '1.5rem' }}>
          <div style={{ position: 'relative', textAlign: 'center', marginBottom: '1rem' }}>
            ...
            <span style={{ position: 'relative', background: 'white', padding: '0 1rem', color: '#9ca3af', fontSize: '0.9rem' }}>Oder</span>
          </div>
